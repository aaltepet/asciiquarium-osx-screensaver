...
class ConfigureSheetController: NSWindowController {
    ...
    private lazy var defaults: ScreenSaverDefaults = {
        // Safely get defaults, creating if needed
        return ScreenSaverDefaults(forModuleWithName: "com.andyaltepeter.AsciiquariumScreensaver")
            ?? ScreenSaverDefaults()
    }()
    ...
    private func setupUI() {
        ...
        fishCountSlider.isContinuous = true  // Update continuously as user drags
    ...
    private func updateLabel() {
        ...
        if value == 0 {
            ...
            fishCountLabel.stringValue = ""  // Hide the automatic text when non-zero
            fishCountLabel.isHidden = true
        }
    }
...
extension ScreenSaverDefaults {
    static func fishCount() -> Int {
        guard
            ...
            // If defaults can't be created, return 0 (automatic)
            return 0
        }
