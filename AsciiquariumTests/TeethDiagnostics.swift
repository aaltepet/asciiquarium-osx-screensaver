...
struct TeethDiagnostics {
    ...
    @Test func testTeethPositioningWithShark() async throws {
        ...
        print("Teeth Y (\(teethY)) within shark Y bounds (\(sharkTop)-\(sharkBottom)): \(teethInSharkBounds)")
    ...
    @Test func testTeethAndFishAtSameDepth() async throws {
        ...
        for fishZ in Depth.fishStart...Depth.fishEnd {
            ...
            print("Fish at z=\(fishZ), teeth at z=\(teeth.position.z): collision=\(fishCollision != nil)")
        }
    }
    ...
    @Test func testTeethMovementWithShark() async throws {
        ...
        print("Initial: shark x=\(initialSharkX), teeth x=\(initialTeethX), offset=\(expectedOffset)")
