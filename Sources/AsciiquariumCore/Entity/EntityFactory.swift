...
public class EntityFactory {
    ...
    public static func create(from spec: EntitySpec) -> Entity {
        switch spec {
    ...
    public static func createFish(at position: Position3D) -> FishEntity {
        return FishEntity(name: "fish_\(UUID().uuidString.prefix(8))", position: position)
    }

    public static func createBubble(at position: Position3D) -> BubbleEntity {
        return BubbleEntity(name: "bubble_\(UUID().uuidString.prefix(8))", position: position)
    }

    public static func createWaterline(at position: Position3D, segmentIndex: Int)
        -> WaterlineEntity
    {
        return WaterlineEntity(
            name: "waterline_\(UUID().uuidString.prefix(8))", position: position,
    ...
    public static func createCastle(at position: Position3D) -> CastleEntity {
        return CastleEntity(name: "castle", position: position)
    }

    public static func createSeaweed(at position: Position3D) -> SeaweedEntity {
        return SeaweedEntity(name: "seaweed_\(UUID().uuidString.prefix(8))", position: position)
    }

    public static func createShark(at position: Position3D) -> SharkEntity {
        return SharkEntity(name: "shark_\(UUID().uuidString.prefix(8))", position: position)
    }

    public static func createTeeth(at position: Position3D, speed: Double, direction: Int)
        -> TeethEntity
    {
        return TeethEntity(
    ...
    public static func createSplat(at position: Position3D) -> SplatEntity {
        return SplatEntity(name: "splat_\(UUID().uuidString.prefix(8))", position: position)
    }

    public static func createShip(at position: Position3D) -> ShipEntity {
        return ShipEntity(name: "ship_\(UUID().uuidString.prefix(8))", position: position)
    }

    public static func createWhale(at position: Position3D) -> WhaleEntity {
        return WhaleEntity(name: "whale_\(UUID().uuidString.prefix(8))", position: position)
    }

    public static func createMonster(at position: Position3D) -> MonsterEntity {
        return MonsterEntity(name: "monster_\(UUID().uuidString.prefix(8))", position: position)
    }

    public static func createSwan(at position: Position3D) -> SwanEntity {
        return SwanEntity(name: "swan_\(UUID().uuidString.prefix(8))", position: position)
    }

    public static func createDucks(at position: Position3D) -> DucksEntity {
        return DucksEntity(name: "ducks_\(UUID().uuidString.prefix(8))", position: position)
    }
