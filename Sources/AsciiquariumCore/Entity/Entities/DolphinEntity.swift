...
// MARK: - Dolphin Entity
public class DolphinEntity: BaseEntity {
    public var direction: Int = 1  // 1 for right, -1 for left
    public var speed: Double = 1.0  // Speed matching Perl: $speed = 1
    ...
    public init(
        name: String, position: Position3D, direction: Int, pathOffset: Int, path: [[Double]]
    ) {
